(function () {
    ...
    angular
        .module('jarvis')
        .component('uiTopbarToggle', {
            templateUrl: ['componentService', function (componentService) {
                return componentService.getTemplateUrl('uiTopbarToggle', '/app/shared/components/topbar-toggle/topbar-toggle.template.html');
            }],
            controller: 'topbarToggleController',
            bindings: {
                context: '='
            }
        })
        .controller('topbarToggleController', ['$scope', '$state', '$timeout', '$uibModal', 'APP_CONFIG', 'httpService', 'cacheService', function ($scope, $state, $timeout, $uibModal, APP_CONFIG, httpService, cacheService) {
            var ctrl = $scope.$ctrl;
            ctrl.currentTenant = {};
