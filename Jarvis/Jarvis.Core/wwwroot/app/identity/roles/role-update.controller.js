(function () {
    ...
    var roleUpdateController = function ($state, $stateParams, sweetAlert, roleService) {
        var ctrl = this;
        ctrl.loading = false;
        ctrl.role = {};
        ctrl.modules = [];
        ...
        ctrl.$onInit = function () {
            ctrl.getRole($stateParams.id);
            ctrl.getClaims($stateParams.id);
        };
        ...
        ctrl.save = function (form) {
            ...
            roleService.put(role).then(function (response) {
                if (response.status === 200) {
                    sweetAlert.swal({
                        title: "Thành công",
    ...
    roleUpdateController.$inject = ['$state', '$stateParams', 'sweetAlert', 'roleService'];
}());