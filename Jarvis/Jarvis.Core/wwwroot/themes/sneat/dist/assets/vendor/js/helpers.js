!function(t, e) {
    ...
    return function() {
                    ...
                    if (null != n) {
                        ...
                        try {
                            if (r = (n = n.call(t)).next, 0 === e) {
                                ...
                                for (; !(u = (i = r.call(n)).done) && (a.push(i.value), a.length !== e); u = !0)
                                    ;
                        } catch (t) {
                            l = !0,
                            o = t
        ...
        return "undefined" != typeof window && (h.init(), h.isMobileDevice() && window.chrome && document.documentElement.classList.add("layout-menu-100vh"), "complete" === document.readyState ? h.update() : document.addEventListener("DOMContentLoaded", (function t() {
            h.update(),
