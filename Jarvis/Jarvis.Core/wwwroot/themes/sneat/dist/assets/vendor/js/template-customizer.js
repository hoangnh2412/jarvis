                        ...
                        return {
                            update: function(s) {
                                !function(t, e, s) {
                                    ...
                                    o && (i += "@layer".concat(s.layer.length > 0 ? " ".concat(s.layer) : "", " {")),
                                    i += s.css,
                                    o && (i += "}"),
                                    s.media && (i += "}"),
                                    s.supports && (i += "}");
                    ...
                    function t(e) {
                        ...
                        if (function(t, e) {
                            ...
                            if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = o || "%name%.css", this.settings.displayCustomizer = void 0 === a || a, this.settings.controls = n || x, this.settings.defaultTextDir = "rtl" === l || k, this.settings.defaultLayoutType = r || N, this.settings.defaultMenuCollapsed = void 0 !== c ? c : C, this.settings.defaultMenuFlipped = void 0 !== u ? u : A, this.settings.defaultShowDropdownOnHover = void 0 !== d ? d : void 0, this.settings.defaultNavbarFixed = void 0 !== h ? h : T, this.settings.defaultFooterFixed = void 0 !== p ? p : E, this.settings.availableThemes = f || t.THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== g ? g : z), this.settings.styles = m || w, this.settings.defaultStyle = y || F, this.settings.lang = _ || "en", this.pathResolver = v || function(t) {
                                ...
                                -1 !== S && (this.settings.controls = this.settings.controls.slice(0, S).concat(this.settings.controls.slice(S + 1)))
                            }
                            this.settings.onSettingsChange = "function" == typeof b ? b : function() {},
                            this._loadSettings(),
                            this._listeners = [],
                            this._controls = {},
                            this._initDirection(),
                    ...
                    return e = t, s = [{
                        ...
                        value: function(t) {
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                if (i) {
                                    ...
                                    this._loadStylesheets(v({}, o, document.querySelector(".template-customizer-theme-css")), s || function() {}),
                        ...
                        value: function() {
                            if (!this._ssr) {
                                ...
                                this._controls.layoutNavbarFixed && (t ? (this._controls.layoutNavbarFixed.removeAttribute("disabled"), this._controls.layoutNavbarFixedW.classList.remove("disabled")) : (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"), this._controls.layoutNavbarFixedW.classList.add("disabled")), s && t && "fixed" == this.settings.layoutType && (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"), this._controls.layoutNavbarFixedW.classList.add("disabled"))),
                                this._controls.layoutFooterFixed && (i ? (this._controls.layoutFooterFixed.removeAttribute("disabled"), this._controls.layoutFooterFixedW.classList.remove("disabled")) : (this._controls.layoutFooterFixed.setAttribute("disabled", "disabled"), this._controls.layoutFooterFixedW.classList.add("disabled"))),
                        ...
                        value: function() {
                            ...
                            this._hasControls("style") || (this.settings.style = S.contains("dark-style") ? "dark" : "light"),
