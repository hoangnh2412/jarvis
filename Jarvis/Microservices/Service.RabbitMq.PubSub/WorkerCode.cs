...
{
    public class WorkerCode : RabbitClient
    {
        private readonly RabbitQueueOption _queueOption;

        public WorkerCode(RabbitQueueOption queueOption, IOptions<RabbitOption> rabbitOptions) : base(queueOption, rabbitOptions)
        {
