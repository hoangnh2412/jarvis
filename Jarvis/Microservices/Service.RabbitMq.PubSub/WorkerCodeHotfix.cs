...
{
    public class WorkerCodeHotfix : RabbitClient
    {
        private readonly RabbitQueueOption _queueOption;

        public WorkerCodeHotfix(RabbitQueueOption queueOption, IOptions<RabbitOption> rabbitOptions) : base(queueOption, rabbitOptions)
        {
