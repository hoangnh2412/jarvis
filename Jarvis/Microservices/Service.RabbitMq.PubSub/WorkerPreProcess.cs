...
{
    public class WorkerPreProcess : RabbitClient
    {
        private readonly RabbitQueueOption _queueOption;

        public WorkerPreProcess(RabbitQueueOption queueOption, IOptions<RabbitOption> rabbitOptions) : base(queueOption, rabbitOptions)
        {
