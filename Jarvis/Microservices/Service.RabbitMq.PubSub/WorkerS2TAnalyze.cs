...
{
    public class WorkerS2TAnalyze : RabbitClient
    {
        private readonly RabbitQueueOption _queueOption;

        public WorkerS2TAnalyze(RabbitQueueOption queueOption, IOptions<RabbitOption> rabbitOptions) : base(queueOption, rabbitOptions)
        {
