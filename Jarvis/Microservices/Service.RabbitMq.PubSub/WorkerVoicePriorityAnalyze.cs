...
{
    public class WorkerVoicePriorityAnalyze : RabbitClient
    {
        private readonly RabbitQueueOption _queueOption;

        public WorkerVoicePriorityAnalyze(RabbitQueueOption queueOption, IOptions<RabbitOption> rabbitOptions) : base(queueOption, rabbitOptions)
        {
