...
- **In scope:** `Jarvis.Caching`, `Jarvis.Caching.Redis`, config `Cache`, Sample wiring, unit tests, skill `.opencode/skills/jarvis-dotnet/modules/caching/SKILL.md`
- **Out of scope (phase sau):** `CachingTenantConnectionStringResolver` (chỉ nhắc trong docs EF), CouchBase/Memcached providers

### 1.3 Chuẩn tham chiếu

- Review checklist: `.opencode/skills/code-review/SKILL.md`
- Style / structure: `CodeBaseSkill.md` (HealthChecks / EF / OTEL patterns)
- Module skill: `.opencode/skills/jarvis-dotnet/modules/caching/SKILL.md`
...
### 4.2 Sentinel TTL (theo CodeBaseSkill §1.3)
...
| 5 | Future: `CachingTenantConnectionStringResolver`, OTEL | Backlog |
