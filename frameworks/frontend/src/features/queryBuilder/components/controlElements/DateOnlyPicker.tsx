...
/**
 * Lightweight date popover (portal) — tránh overflow-hidden của card QB
 * và tránh auto-close / decade-view của PrimeReact DatePicker.
 */
export const DateOnlyPicker = memo(function DateOnlyPicker({
  value,
  onChange,
  title,
  disabled,
    ...
    open && panelPos
      ? createPortal(
          <div
            ...
            className="fixed z-[500] w-[19.5rem] overflow-hidden rounded-2xl border border-slate-200/90 bg-white text-slate-900 shadow-[0_16px_48px_-12px_rgba(15,23,42,0.28)]"
          ...
          >
            ...
            <div className="mt-2 flex items-center justify-end gap-2 border-t border-slate-100 bg-slate-50/60 px-3.5 py-2.5">
              <button
                type="button"
