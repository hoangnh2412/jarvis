...
internal static class TenantScopedContextValidation
{
    ...
    private static bool RequiresTenant(DbContext context)
    {
        ...
        // Master DbContexts may map ITenantEntity types (e.g. Setting) alongside catalog entities.
        // Only require ambient TenantId when the change set actually touches tenant-scoped rows.
